...
public class NSTitleFrame extends JFrame {

	public NSTitleFrame() throws HeadlessException {
		super();
		initFrame();
	}

	public NSTitleFrame(GraphicsConfiguration gc) {
		super(gc);
		initFrame();
	}

	public NSTitleFrame(String title) throws HeadlessException {
		super(title);
		initFrame();
	}

	public NSTitleFrame(String title, GraphicsConfiguration gc) {
		super(title, gc);
		initFrame();
	}

	private NSTitle titleComponent;
	...
	private void initFrame() {
		titleComponent = new NSTitle(this);
	//	contentPanel.setBorder(new NSTitleBorder());
	...
	public NSTitle getTitleComponent() {
