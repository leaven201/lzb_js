...
public class NSTitleDialog extends JDialog {

	public NSTitleDialog() {
		super();
		initDialog();
	}

	public NSTitleDialog(Window owner) {
		super(owner);
		initDialog();
	}

	public NSTitleDialog(Window owner, String title) {
		super(owner, title);
		setTitle(title);
		initDialog();
	}

	public NSTitleDialog(Window owner, String title, boolean modal) {
		super(owner, title);
		this.setModal(modal);
		initDialog();
	}

	private NSTitle1 titleComponent;
	...
	private void initDialog() {
		titleComponent = new NSTitle1(this);
	...
	public NSTitle1 getTitleComponent() {
