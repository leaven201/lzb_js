...
public class MySplitPaneUI extends BasicSplitPaneUI {   
	private static Color splitColor = new Color(255,255,255);
    private static final Color BG_COLOR = splitColor;   
    private static final MySplitPaneUI cornerButtonUI = new MySplitPaneUI();   
