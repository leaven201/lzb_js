...
public class DataSave {
	...
	public static int GuardBand = 1;// 保护频隙数
	public static double Cslot = 12.5;// 采用BPSK（M=1）调制格式时，一个频隙对应的带宽为12.5GE
	public static double BPSK;// OSNR高于此用BPSK调制，相当于过系统OSNR要求的值，低于此值则不满足OSNR要求
	public static double QPSK;// OSNR高于此用QPSK调制 v
	public static double _16QAM;// OSNR高于此用16QAM调制
