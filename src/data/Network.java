...
//	}
	...
	public void addInNetLink(BasicLink link){
		switch(link.getM_eLayer()){
		case Fiber:
			this.m_lInNetFiberLinkList.add((FiberLink)link);
			
			break;
		case WDM:
			this.m_lInNetWDMLinkList.add((WDMLink)link);
			break;
		case OTN:
			this.m_lInNetOTNLinkList.add((WDMLink)link);
			break;
//		case SDH:
//			this.m_lInNetSDHLinkList.add((SDHLink)link);
//			break;
//		case ASON:
//			this.m_lInNetASONLinkList.add((SDHLink)link);
		default:
			break;
		}
