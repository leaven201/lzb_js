...
public class Dlg_PolicySetting extends JFrame {
	...
	private static JRadioButton[] arithmetic = new JRadioButton[5];// 选择路由算法
...
class SetZ extends JDialog {
	...
	private JLabel explication1 = new JLabel("1、A：距离，B：时延，C：跳数，D：负载");
	...
	private double[] safeCoefficient = { 0.2, 0.3, 0.2, 0.3 };// 安全性各项相应的系数
