...
public class NodeData {
	...
	public void addNode(int id, String name, double longitude, double latitude, boolean isActive, boolean isOA,
			boolean isROADM, boolean isOTN, int maxPortNum, double switchCapacity, NodeType nodeType, int numOB,
			int numOP, int numOA, boolean isEleRegeneration, boolean isWaveConversion) {
...
//	}
	...
	public void addROADMNode(int id, String name, String otherName, double longitude, double latitude,
